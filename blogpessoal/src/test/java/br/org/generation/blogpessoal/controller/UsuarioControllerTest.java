...
public class UsuarioControllerTest {
	...
	public void naoDeveDuplicarUsuario() {
		...
		usuarioService.cadastrarUsuario(new Usuario (0L,
				"Manuela da Silva", "manuela@email.com.br", "12345678", ""));
		
		HttpEntity<Usuario> requisicao = new HttpEntity<Usuario>(new Usuario (0L,  "Manuela da Silva", "manuela@email.com.br", "12345678", ""));
	...
	public void deveListarApenasUmUsuario() {
		Optional<Usuario> usuarioBusca = usuarioService.cadastrarUsuario(new Usuario(0L, "Pedro Santos", "pedro@email.com.br", "12345678", ""));
		ResponseEntity<String> resposta = testRestTemplate.withBasicAuth("root", "root").exchange("/usuarios/" + usuarioBusca.get().getId(), HttpMethod.GET, null, String.class);
	assertEquals(HttpStatus.OK, resposta.getStatusCode());
	}
